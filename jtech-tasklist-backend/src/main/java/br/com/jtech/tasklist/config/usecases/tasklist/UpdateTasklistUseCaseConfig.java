...
import br.com.jtech.tasklist.adapters.output.tasklist.UpdateTasklistAdapter;
...
public class UpdateTasklistUseCaseConfig {
	...
	@Bean
	public UpdateTasklistUseCase useCaseUpdate(UpdateTasklistAdapter updateTasklistAdapter) {
