...
import br.com.jtech.tasklist.adapters.output.tasklist.DeleteTasklistAdapter;
...
public class DeleteTasklistUseCaseConfig {
	...
	@Bean
	public DeleteTasklistUseCase useCaseDelete(DeleteTasklistAdapter deleteTasklistAdapter) {
		return new DeleteTasklistUseCase(deleteTasklistAdapter);
	}
