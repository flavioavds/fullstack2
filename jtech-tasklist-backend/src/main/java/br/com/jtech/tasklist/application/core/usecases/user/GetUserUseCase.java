...
* user flavio.augusto  
*/
public class GetUserUseCase implements GetUserInputGateway {
    private final GetUserOutputGateway outputGateway;
    
    public GetUserUseCase(GetUserOutputGateway outputGateway) {
